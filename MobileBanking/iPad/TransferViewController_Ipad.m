...
#import "TransferViewController_Ipad.h"
...
@implementation TransferViewController_Ipad
...
-(IBAction)clickontarnsfer:(id)sender
{
	...
	{
		UIAlertView *alert	=	[[UIAlertView alloc]initWithTitle:@"Mobile Banking - transfer" message:[NSString stringWithFormat:@"Amount: %@\nEffectiveDate: %@\nAccount:%@\nSLType: %@\nSuffix: %@\nFromBalance: %@\nFromAvailable: %@\nToAccount: %@\nToSLType: %@\nToSuffix: %@\nToAvailable: %@\n\n",string_ammount,string_effectiveDate,string_account,string_SLtype,string_suffix,string_frombalance,string_fromavail,string_toaccount,string_toSLtype,string_tosuffix,string_toavail] delegate:self cancelButtonTitle:@"cancel" otherButtonTitles:nil];
...
/////////From here code for picker view start
